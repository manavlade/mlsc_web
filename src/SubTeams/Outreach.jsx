...
export default function Outreach() {
    // const outRechRef = React.useRef(null);
    // useEffect(() => {
    //     const observer = new IntersectionObserver(
    //         ([entry]) => {
    //             if (entry.isIntersecting) {
    //                 TeamsLeftRef.current.classList.add('Cvisible');
    //             }
    //         },
    //         {
    //             threshold: 0.7,
    //         }
    //     );
    //     observer.observe(outRechRef.current);
    //     return () => observer.disconnect();

    // }, [])
    // useEffect(() => {
    //     const corporate = new IntersectionObserver(
    //         (entries) => {
    //             entries.forEach((entry) => {
    //                 if(entry.isIntersecting){
    //                     entry.target.classList.add('Cvisible')
    //                 }
    //                 else {
    //                     entry.target.classList.remove('Cvisible')
    //                 }
    //             });
    //         },
    //         {
    ...
    //         }
    //     );
    //     corporate.observe(outRechRef.current);
    //     return () => corporate.disconnect();
    // },[])
    return (
        <>      
        <h1 className='title'>Meet our OutReach Team </h1>
